...
namespace NotesApp.Application.Tests.Tasks
{
    public sealed class GetTaskDetailQueryHandlerTests
    {
        ...
        public async Task Handle_returns_task_detail_for_current_user()
        {
            ...
            var handler = new GetTaskDetailQueryHandler(taskRepository, new SubtaskRepository(context), new AttachmentRepository(context), new RecurringTaskAttachmentRepository(context), new RecurringTaskExceptionRepository(context), currentUserMock.Object);
