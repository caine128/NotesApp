...
description: Use when writing or refactoring C# code, designing APIs, improving performance, or applying modern .NET patterns (records, async, Span, Result pattern). Emphasizes functional-style programming with C# 12+ features.
invocable: false
---
